...
<body>
		...
		<div id="contenidoTotal">
				<div id="contenidoApuntes">
						...
						<input type="text" id="boton3">
						<script>
								var botonUno = document.getElementById("boton1");
								botonUno.style.width = "100px";
								botonUno.style.height = "100px";
								var botonDos = document.getElementById("boton2");
								botonDos.style.width = "100px";
								botonDos.style.height = "100px";
								var botonTexto = document.getElementById("boton3");
								// botonUno.style.backgroundColor = "red";
								botonUno.focus();
								botonTexto.style.background = "pink";
								botonTexto.value = "Escriba aquí...";
								botonTexto.style.width = "100px"
								botonTexto.style.height = "100px"
						</script>
						<script>
